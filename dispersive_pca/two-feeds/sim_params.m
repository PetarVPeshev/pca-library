...
params_slot = struct('er_up', 11.7, 'er_dn', 1);
...
params_laser = struct('wlen', 780 * 1e-9, 'T', 12.5 * 1e-9, ...
...
% Height                     : 2 um
params_pcm = struct('wz', 2 * 1e-6, 'er', 12.96, ...
                    'tau_rec', 300 * 1e-15, 'tau_s', 8.5 * 1e-15, ...
